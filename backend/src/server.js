...
app.use(cors({
  origin: ['https://sports-scholarship-6olq-bj9rvq2ip-kush-sahnis-projects.vercel.app','http://localhost:5173', 'http://127.0.0.1:5173', 'http://localhost:8081', 'http://localhost:8080','http://127.0.0.1:8081'],
  credentials: true,
